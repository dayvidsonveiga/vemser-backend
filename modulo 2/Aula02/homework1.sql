...
INSERT INTO VEMSER_DAYVIDSON.ESTADO (ID_ESTADO, ID_PAIS, NOME) VALUES (seq_estado.nextval, 1, 'Bahia');

INSERT INTO VEMSER_DAYVIDSON.ESTADO (ID_ESTADO, ID_PAIS, NOME) VALUES (seq_estado.nextval, 2, 'New York');
INSERT INTO VEMSER_DAYVIDSON.ESTADO (ID_ESTADO, ID_PAIS, NOME) VALUES (seq_estado.nextval, 2, 'Texas');
...
INSERT INTO VEMSER_DAYVIDSON.CIDADE (ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_cidade.nextval, 2, 'Salvador');
INSERT INTO VEMSER_DAYVIDSON.CIDADE (ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_cidade.nextval, 2, 'Feira de Santana');

INSERT INTO VEMSER_DAYVIDSON.CIDADE (ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_cidade.nextval, 3, 'New York');
INSERT INTO VEMSER_DAYVIDSON.CIDADE (ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_cidade.nextval, 3, 'Syracuse');

INSERT INTO VEMSER_DAYVIDSON.CIDADE (ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_cidade.nextval, 4, 'Houston');
INSERT INTO VEMSER_DAYVIDSON.CIDADE (ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_cidade.nextval, 4, 'Dallas');


INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 1, 1, 'Paraíso');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 1, 1, 'Sacomã');

INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 2, 1, 'Demarchi');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 2, 1, 'Centro');

INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 3, 2, 'Acupe');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 3, 2, 'Aeroporto');

INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 4, 2, 'Centro');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 4, 2, 'Queimadinha');

INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 5, 3, 'Brooklyin');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 5, 3, 'Manhattan');

INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 6, 3, 'Lakefront');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 6, 3, 'South Valley');

INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 7, 4, 'Clear Lake City');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 7, 4, 'Mid Town');

INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 8, 4, 'Deep Ellum ');
INSERT INTO VEMSER_DAYVIDSON.BAIRRO (ID_BAIRRO, ID_CIDADE, ID_ESTADO, NOME) VALUES (seq_bairro.nextval, 8, 4, 'Oak Lawn');
